...
namespace Hw_16.Migrations
{
    ...
    [Migration("20241205180737_adduser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CardBankTransaction_HW_15.Entities.Card", b =>
                {
            ...
            modelBuilder.Entity("CardBankTransaction_HW_15.Entities.Transactionn", b =>
                {
            ...
            modelBuilder.Entity("CardBankTransaction_HW_15.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CardBankTransaction_HW_15.Entities.Card", b =>
                {
                    b.HasOne("CardBankTransaction_HW_15.Entities.User", "User")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("CardBankTransaction_HW_15.Entities.Transactionn", b =>
                {
                    b.HasOne("CardBankTransaction_HW_15.Entities.Card", "DestinationCard")
                        .WithMany("TransactionnsAsDestination")
                        .HasForeignKey("DestinationCardid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CardBankTransaction_HW_15.Entities.Card", "SourceCard")
